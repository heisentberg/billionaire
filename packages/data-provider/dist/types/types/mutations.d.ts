...
import { Assistant, AssistantCreateParams, AssistantUpdateParams, ActionMetadata, FunctionTool, AssistantDocument, Action } from './assistants';
...
export type DeletePresetOptions = {
    onSuccess?: (data: PresetDeleteResponse, variables: TPreset | undefined, context?: unknown) => void;
...
export type UpdateAssistantMutationOptions = {
    onSuccess?: (data: Assistant, variables: {
        assistant_id: string;
...
export type UpdateActionOptions = {
    onSuccess?: (data: UpdateActionResponse, variables: UpdateActionVariables, context?: unknown) => void;
...
export type DeleteConversationOptions = {
    onSuccess?: (data: TDeleteConversationResponse, variables: TDeleteConversationRequest, context?: unknown) => void;
