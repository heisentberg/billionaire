...
var alternateName = (_a = {},
    _a[EModelEndpoint.openAI] = 'OpenAI',
    _a[EModelEndpoint.assistant] = 'Assistants',
    _a[EModelEndpoint.azureOpenAI] = 'Azure OpenAI',
    _a[EModelEndpoint.bingAI] = 'IntelliumGPT',
    _a[EModelEndpoint.chatGPTBrowser] = 'ChatGPT',
    _a[EModelEndpoint.gptPlugins] = 'Plugins',
    _a[EModelEndpoint.google] = 'PaLM',
    _a[EModelEndpoint.anthropic] = 'Anthropic',
    _a);
var EndpointURLs = (_b = {},
    _b[EModelEndpoint.azureOpenAI] = '/api/ask/azureOpenAI',
    _b[EModelEndpoint.openAI] = '/api/ask/openAI',
    _b[EModelEndpoint.bingAI] = '/api/ask/bingAI',
    _b[EModelEndpoint.chatGPTBrowser] = '/api/ask/chatGPTBrowser',
    _b[EModelEndpoint.google] = '/api/ask/google',
    _b[EModelEndpoint.gptPlugins] = '/api/ask/gptPlugins',
    _b[EModelEndpoint.anthropic] = '/api/ask/anthropic',
    _b[EModelEndpoint.assistant] = '/api/assistants/chat',
    _b);
...
var supportsFiles = (_c = {},
    _c[EModelEndpoint.openAI] = true,
    _c[EModelEndpoint.assistant] = true,
    _c);
var openAIModels = [
...
var endpointSchemas = (_d = {},
    _d[EModelEndpoint.openAI] = openAISchema,
    _d[EModelEndpoint.azureOpenAI] = openAISchema,
    _d[EModelEndpoint.google] = googleSchema,
    _d[EModelEndpoint.bingAI] = bingAISchema,
    _d[EModelEndpoint.anthropic] = anthropicSchema,
    _d[EModelEndpoint.chatGPTBrowser] = chatGPTBrowserSchema,
    _d[EModelEndpoint.gptPlugins] = gptPluginsSchema,
    _d[EModelEndpoint.assistant] = assistantSchema,
    _d);
...
var useGetConvoIdQuery = function (id, config) {
    var queryClient = useQueryClient();
    return useQuery([QueryKeys.conversation, id], function () {
        var _a;
        var defaultQuery = function () { return getConversationById(id); };
        var convosQueryKey = [QueryKeys.allConversations, { pageNumber: '1', active: true }];
...
var useGetConversationsQuery = function (pageNumber, config) {
    return useQuery([QueryKeys.allConversations, { pageNumber: pageNumber, active: true }], function () { return getConversations(pageNumber); }, __assign({ refetchOnReconnect: false, refetchOnMount: false, retry: 1 }, config));
};
...
var useListAssistantsQuery = function (params, config) {
    return useQuery([QueryKeys.assistants, params], function () { return listAssistants(params); }, __assign({ 
...
var useListAssistantsInfiniteQuery = function (params, config) {
    return useInfiniteQuery(['assistantsList', params], function (_a) {
...
var useCreateAssistantMutation = function () {
    var queryClient = useQueryClient();
    return useMutation(function (newAssistantData) { return createAssistant(newAssistantData); }, {
        onSuccess: function () {
...
var useGetAssistantByIdQuery = function (assistant_id, config) {
    return useQuery([QueryKeys.assistant, assistant_id], function () { return getAssistantById(assistant_id); }, __assign({ enabled: !!assistant_id, refetchOnWindowFocus: false, refetchOnReconnect: false, refetchOnMount: false, retry: false }, config));
};
/**
...
export { EModelEndpoint, EndpointURLs, MutationKeys, QueryKeys, SSE, Tools, alternateName, anthropicSchema, assistantSchema, bingAISchema, chatGPTBrowserSchema, compactAnthropicSchema, compactChatGPTSchema, compactGoogleSchema, compactOpenAISchema, compactPluginsSchema, createPayload, dataService, defaultEndpoints, eModelEndpointSchema, getFirstDefinedValue, getResponseSender, googleSchema, gptPluginsSchema, modularEndpoints, openAIModels, openAISchema, parseCompactConvo, parseConvo, removeNullishValues, request, setAcceptLanguageHeader, setTokenHeader, supportsFiles, tAgentOptionsSchema, tConversationSchema, tExampleSchema, tMessageSchema, tPluginAuthConfigSchema, tPluginSchema, tPresetSchema, useAbortRequestWithMessage, useAvailablePluginsQuery, useClearConversationsMutation, useCreateAssistantMutation, useCreatePresetMutation, useDeleteAssistantMutation, useDeleteConversationMutation, useDeletePresetMutation, useGetAssistantByIdQuery, useGetConversationByIdMutation, useGetConversationByIdQuery, useGetConversationsQuery, useGetConvoIdQuery, useGetEndpointsQuery, useGetMessagesByConvoId, useGetModelsQuery, useGetPresetsQuery, useGetSearchEnabledQuery, useGetStartupConfig, useGetUserBalance, useGetUserQuery, useListAssistantsInfiniteQuery, useListAssistantsQuery, useLoginUserMutation, useLogoutUserMutation, useRefreshTokenMutation, useRegisterUserMutation, useRequestPasswordResetMutation, useResetPasswordMutation, useRevokeAllUserKeysMutation, useRevokeUserKeyMutation, useSearchQuery, useUpdateAssistantMutation, useUpdateConversationMutation, useUpdateMessageMutation, useUpdatePresetMutation, useUpdateTokenCountMutation, useUpdateUserKeysMutation, useUpdateUserPluginsMutation, useUserKeyQuery };
