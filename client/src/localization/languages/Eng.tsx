...
export default {
  ...
  com_ui_new_footer: 'нь Интеллиум компанийн өмч бөгөөд зөвшөөрөлгүй ашигласан тохиолдолд хариуцлага тооцох аюултайг анхаарна уу!',
  com_ui_enter: 'Enter',
  ...
  com_endpoint_bing_system_message_placeholder:
    'WARNING: Misuse of this feature can get you BANNED from using Bing! Click on \'System Message\' for full instructions and the default message if omitted, which is the \'IntelliumGPT\' preset that is considered safe.',
  ...
  com_nav_welcome_message: 'Welcome to IntelliumGPT',
