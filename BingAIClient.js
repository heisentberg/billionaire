...
export default class BingAIClient {
    ...
    async sendMessage(
        ...
        const {
            toneStyle = 'gpt-4-0125-preview', // or creative, precise, fast
            invocationId = 0,
            systemMessage,
        ...
        let toneOption;
        if (toneStyle === 'gpt-4-0125-preview') {
            toneOption = 'gpt-4-0125-preview';
        } else if (toneStyle === 'gpt-4-0125-preview') {
            toneOption = 'gpt-4-0125-preview';
        } else if (toneStyle === 'gpt-4-0125-preview') {
            ...
            arguments: [
                {
                    ...
                    optionsSets: [
                        ...
                        'dv3sugg',
                        'nojbfedge',
                        ...((toneStyle === 'gpt-4-0125-preview' && this.options.features.genImage) ? ['gencontentv3'] : []),
                    ],
                    sliceIds: [
                        '222dtappid',
                        '225cricinfo',
